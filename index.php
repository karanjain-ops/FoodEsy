...
<body>
  <?php include 'https://foodesy.herokuapp.com/partials/_dbconnect.php';?>
  <?php require 'https://foodesy.herokuapp.com/partials/_nav.php' ;?>
  
  <!-- Category container starts here -->
  <div class="container my-3 mb-5">
    <div class="col-lg-2 text-center my-3" style="margin:auto;">     
      <h2 class="text-center" style="color: orange;font-family: 'Fasthand', cursive;font-size: 50px;">Categories</h2>
    </div>
    <div class="row">
