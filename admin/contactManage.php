				...
				<table class="table-striped table-bordered col-md-12 text-center">
                    ...
                    <tbody>
                        <?php
                            ...
                            if($count==0) {
                              ?><script> document.getElementById("notempty").innerHTML = '<div class="alert alert-info alert-dismissible fade show" role="alert" style="width:100%"> No Messages Recieved!!	</div>';
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(187 188 189);">
              <h5 class="modal-title" id="history">Messages Sent</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <?php 
                    ...
                    if($totalReply==0) {
                      ?><script> document.getElementById("notReply").innerHTML = '<div class="alert alert-info alert-dismissible fade show" role="alert" style="width:100%"> No Replies !!	</div>';</script> <?php
                    }   
