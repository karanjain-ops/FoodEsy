...
echo '<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #1d3b57;">
      <a class="navbar-brand" href="index.php"><img height=60px src="img/logo.jpg" alt="Restaurant Logo" class="img-responsive"><span style="font-size: 26px; text-decoration: double underline orange 2px;">'.$systemName.'</span></a>
